...
var RandomChaoWheelChaoPrizes = map[string]float64{
	...
	enums.ChaoIDStrCartridge:            1.03, // Event (Birthday; Increase Odds During Event) - Permanent Pool
 	enums.ChaoIDStrDeathEgg:             1.22, // Event (Birthday; Increase Odds During Event) - Permanent Pool
	...
	enums.ChaoIDStrLightChaos: 1.22, // Permanent Pool
	enums.ChaoIDStrHeroChaos:  1.22, // Permanent Pool
	enums.ChaoIDStrDarkChaos:  1.22, // Permanent Pool
	enums.ChaoIDStrChip:       1.22, // Permanent Pool
	// enums.ChaoIDStrShahra:               4.0, // Runners' League Story Mode
	enums.ChaoIDStrCaliburn:         1.22, // Permanent Pool
	enums.ChaoIDStrKingArthursGhost: 1.22, // Permanent Pool
	enums.ChaoIDStrRCTornado:        1.22, // Permanent Pool
	enums.ChaoIDStrRCBattleCruiser:  1.22, // Permanent Pool
	enums.ChaoIDStrRedCrystalMonsterS: 1.22, // Permanent Pool
	enums.ChaoIDStrRedCrystalMonsterL: 1.22, // Permanent Pool
	enums.ChaoIDStrGoldenGoose:        1.22, // Permanent Pool
	enums.ChaoIDStrRCPirateSpaceship: 1.22, // Permanent Pool
	enums.ChaoIDStrGoldenAngel:       1.22, // Permanent Pool
	enums.ChaoIDStrRCTornado2:           1.22, // Event (Sonic Adventure; Increase Odds During Event) - Permanent Pool
	enums.ChaoIDStrChaos:                1.22, // Event (Sonic Adventure; Increase Odds During Event) - Permanent Pool
	...
	enums.ChaoIDStrRCBlockFace: 1.22, // Permanent Pool
	//enums.ChaoIDStrDFekt:                0.0, // Revival Event (assets TBD)
	enums.ChaoIDStrDarkChaoWalker:       1.22, // Permanent Pool
